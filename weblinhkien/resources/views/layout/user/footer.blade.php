  ...
  <!-- messinger -->
  <div class="hotro">
    <a href="https://www.messenger.com/t/huypeoo" class="mess mb-4" > 
    ...
    <div class="row">
      <div class="col-md-4 mt-md-0 vien">
        <div class="d-flex p-3 text-white ml-5">
          ...
          <div class="p-2  mt-3"><h6> 24/7 Support </h6></div>
        </div>
      </div>
      <div class="col-md-4 mt-md-0 vien ">
        ...
        <div class="d-flex p-3 text-white">
          ...
          <div class="p-2  mt-3"><h6>Customer security </h6></div>
        </div>
        </div>
        ...
        <div class="col-md-4 mt-md-0 vien">
          ...
          <div class="d-flex p-3 text-white ml-5">
            ...
            <div class="p-2  mt-3"><h6>Fast delivery</h6></div>
          </div>
          </div>
  ...
  <div class="container mt-3 mb-3">
    ...
    Email:  19521643@gm.uit.edu.vn <br>
      ...
      <!-- Social buttons -->
          <ul class="list-unstyled text-center ">
            <li class="list-inline-item">
              <a href="https://www.facebook.com/huypeoo" class="btn btn-outline-warning mx-1">
