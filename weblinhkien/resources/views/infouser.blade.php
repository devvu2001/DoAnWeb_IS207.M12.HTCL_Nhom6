...
<div class="col-sm-2">
    <div class="row">
    <button type="button" class="btn btn-danger"> <i class="fas fa-user"></i> Customer information</button>
</div>
<div class="row mt-3">
    <button type="button" class="btn btn-danger"> <i class="fas fa-info-circle"></i> Order detail</button>
</div>
</div>
<div class="  bg-white border rounded border-info col-sm-10">
    <h3 class="mt-3" style="font-weight: bold; color: #4A235A;">Customer Information</h3>
    <div class="row">
