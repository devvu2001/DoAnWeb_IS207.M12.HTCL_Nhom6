...
<div class="container bg-white jumbotron">
  <div class="row mt-3 ">
    <h4 class="list-product-title col-sm-12 bg-danger text-white"> <i class="fas fa-bolt"></i>   ONLINE DISCOUNT</h4>
   <div class="list-product-subtitle text-secondary">
     <h5>On sale products</h5></div>
          ...
          <div class="card card-product">
            ...
            <div class="card-body">
              ...
              <div class="card-text">
                ...
                <a class="btn btn-outline-success btn-detail mt-2 font-weight-bold" href="{{ route('detail.show',$product->productID) }}"> View detail</a>
  ...
  <div class="row mt-5">
    <div class="col-12">
      <button type="button" class="btn btn-outline-danger btn-block ">View all</button>
    </div>
  </div>
</div>
<!-- Kết thúc list -->
...
<h3 style="display: inline;">CASE</h3>
</div>
<div class="container bg-white jumbotron">
...
<div class="row mt-5">
    ...
    <a href="case.html"  type="button" class="btn btn-outline-danger  " style="margin: auto; width: 30%;">View all</a>
...
<div class=" mt-5 text-info">
  <img src="public/frontend/image/icon/Capture.PNG" alt=""   class="mb-3"> 
  <h3 style="display: inline;">Monitor</h3>
</div>
 <div class="container bg-white jumbotron">
  <div class="row bg-white" >
    <div class="product-group">
          ...
          <div class="card card-product">
            ...
            <div class="card-body">
              ...
              <div class="card-text">
                ...
                <br>
                <a class="btn btn-success btn-add-to-cart mt-2" onclick="AddCart({{ $item->productID }})" href="javascript:"><i class="fas fa-cart-arrow-down"></i></a>
                <a class="btn btn-outline-success btn-detail mt-2 font-weight-bold" href="{{ route('detail.show',$item->productID) }}"> View detail</a>
                <span class="badge badge-danger text-white"><h6>{{ $item->discountPercent }}%</h6></span>
  ...
  <div class="row mt-5">
      ...
      <a href="card.html"   type="button" class="btn btn-outline-danger  " style="margin: auto; width: 30%;">View all</a>
