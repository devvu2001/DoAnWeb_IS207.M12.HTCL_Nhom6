...
<div class="container bg-white jumbotron">
   <div class="row">
      <h4 class="list-product-title col-sm-12 bg-danger text-white" style="text-align: left;"> <i class="fa fa-shopping-basket"></i> Your cart</h4>
      <div class="table" id="list-cart">
         ...
         <table class="table table-hover">
            ...
            <tbody>
               ...
               <tr>
                  ...
                  <td> 
                     <button type="button" class="btn btn-danger" onclick="DeleteListItemCart({{ $item['productInfo']->productID }});">Delete</button>
                  </td>
               </tr>
               @endforeach    
        ...
        @endif
         ...
         <div style="color: #4A235A;">
            <p>
            <h5>Your cart is having {{ Session::get('Cart')->totalQuanty }} Product</h5>
            </p>
            <p class="font-weight-bold">This is your Total price: 
            <h4>{{number_format(Session::get('Cart')->totalPrice)}}₫</h4>
            </p>
         </div>
         <a href="{{ url('checkout') }}">
         <b><input type="submit" value="Make order" style=" background: linear-gradient(to right, #DC143C,#7D3C98);  color: #ffffff; font-size: 15px;  font-weight: bold;" class="button btn btn-light"></b></a>
         @else
         
            <h2 style="color: #4A235A;">You have not had any products yet !</h2>
